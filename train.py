...
def parse_opt(known=False):
    ...
    parser.add_argument("--cfg", type=str, default="", help="yolov5s_tissue and lipstick.yaml path")
    parser.add_argument("--data", type=str, default=ROOT / "data/tissue and lipstick.yaml", help="dataset.yaml path")
