...
def parse_opt():
    ...
    parser.add_argument("--data", type=str, default=ROOT / "data/tissue and lipstick.yaml", help="tissue and lipstick.yaml path")
    parser.add_argument("--weights", nargs="+", type=str, default=ROOT / "runs" / "train" / "exp6" / "weights" / "best.pt")
